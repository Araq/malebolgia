...
import "../../../nim-taskpools/taskpools/taskpools"
...
import std / [monotimes, cpuinfo]

tp = Taskpool.new(num_threads = countProcessors()) # Default to the number of hardware threads.
